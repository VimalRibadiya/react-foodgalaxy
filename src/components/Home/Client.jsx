        ...
        <div className="container">
          <div className="client-inner">
            <div className="tomato1">
              <img src="/assets/images/testi-shape-1.png" alt="testi-shape-1" />
            </div>
            <div className="tomato2">
              <img src="/assets/images/testi-shape-2.png" alt="testi-shape-2" />
            </div>
            <div className="tomato3">
              <img src="/assets/images/testi-shape-3.png" alt="testi-shape-3" />
            </div>
            <div className="tomato4">
              <img src="/assets/images/testi-shape-4.png" alt="testi-shape-4" />
            </div>
            ...
            <div className="client-content">
              <div className="img-content">
                <img src="/assets/images/testi.jpg" alt="testi" />
                <div className="quote">
